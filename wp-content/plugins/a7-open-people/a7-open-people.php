...
function a7_admin_enqueue($hook) {
...
function a7_get_function_name($param = '') {
...
function a7_function_name($param = '') {
	echo a7_get_function_name($param);	
}
...
//add_action( 'widgets_init', 'a7_register_plugin_widget' );
function a7_register_plugin_widget() {  
    register_widget( 'a7_Plugin_Widget' );  
}  

class a7_Plugin_Widget extends WP_Widget {
...
function a7_register_plugin_settings() {
...
function a7_options_callback_function() {
?>
	<div class="wrap">
		<h2>Page Title</h2>
...
function a7_custom_custom_taxonomies()  {
	$labels = array(
...
add_action( 'init', 'a7_create_open_person' );

function a7_create_open_person() {
	register_post_type( 'open_person',
		array(
			'labels' => array (
				'menu_name' => 'People',
            ...
            'show_in_nav_menus' => true,
            'show_in_admin_bar' => true,
            'rewrite' => array( 'with_front' => false, 'slug' => 'person' ),
			//'supports' => array( 'title', 'editor', 'thumbnail', 'author' ),
			//'description' => '',
			...
			//'is_active' => 1,
			//'custom_fields' =>  array (),
			//'original_post_type_name' => 'open_person',
		)
	);
}
 ...
 */
function a7_register_cpt_metabox() {
